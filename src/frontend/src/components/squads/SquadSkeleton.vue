<template>
  ...
  bg-gray-100 dark:bg-blue-gray-600 dark:ring-bg-blue-gray-700">
    ...
    <div class="p-5">
      <div class="animate-pulse bg-gray-400 rounded h-5 mb-3 w-60 md:w-80"/>
      <div class="animate-pulse bg-gray-400 rounded h-5 mb-3 w-56 md:w-72"/>
      <div class="animate-pulse bg-gray-400 rounded h-5 mb-3 w-52 md:w-64"/>
    </div>
  </div>
</template>
