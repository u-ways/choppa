<template>
  <StandardPageTemplate>
    ...
    <template v-slot:fixed-width class="m-5">
      <!-- eslint-disable -->
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Choppa.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to Choppa, accessible from <a href="https://www.choppa.app" rel="external nofollow noopener" target="_blank">https://www.choppa.app</a></p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: admin@choppa.app</li>
      </ul>
    </template>
  </StandardPageTemplate>
</template>
